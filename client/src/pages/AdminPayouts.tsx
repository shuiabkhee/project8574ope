                    ...
                    <tbody>
                      {filteredChallenges.map((challenge: Challenge) => (
                        <tr key={challenge.id} className="border-b border-slate-800 hover:bg-slate-800">
                          ...
                          <td className="p-3 text-slate-300">
                            <div>{getCurrencySymbol(challenge.paymentTokenAddress)}{parseFloat(challenge.amount).toLocaleString()}</div>
                            <div className="text-xs text-slate-500">Each participant</div>
                          </td>
                          <td className="p-3 text-purple-400">
                            {getCurrencySymbol(challenge.paymentTokenAddress)}{(parseFloat(challenge.amount) * 2 * 0.05).toLocaleString()}
                          </td>
                          <td className="p-3">
                            {challenge.result ? (
