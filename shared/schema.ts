...
export const challenges = pgTable("challenges", {
  ...
  // New Escrow and Vote model fields
  settlementType: varchar("settlement_type").default("voting"), // voting, uma
  creatorStaked: boolean("creator_staked").default(false),
  acceptorStaked: boolean("acceptor_staked").default(false),
  creatorVote: varchar("creator_vote"), // userId of the winner or "draw"
  acceptorVote: varchar("acceptor_vote"), // userId of the winner or "draw"
  creatorProof: text("creator_proof"), // URL or description of proof
